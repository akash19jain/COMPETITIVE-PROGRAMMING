...
int main()
{
    char str[100005];
    SCS(str);
    ll len=SZ(str),c=0,c1=0;
    REP(i,len-1)
    {
        if(str[i]=='A' && str[i+1]=='B' && c==0)
        {
            c++;
            i++;
        }
        else if(str[i]=='B' && str[i+1]=='A' && c==1)
        {
            c++;
            i++;
        }
    ...
    REP(i,len-1)
    {
        if(str[i]=='A' && str[i+1]=='B' && c1==1)
        {
            c1++;
            i++;
        }
        else if(str[i]=='B' && str[i+1]=='A' && c1==0)
        {
            c1++;
            i++;
        }
