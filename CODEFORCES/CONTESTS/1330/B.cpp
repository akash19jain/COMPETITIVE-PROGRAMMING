...
int main()
{
	...
	CASES
	{
		...
		ll arr[n];
		SCA(arr, n);
		set<ll> st1, st2, st3, st4;
		ll i = 0;
		ll total = 0, s1 = 0, s2 = 0, s3 = 0, s4 = 0;
		...
		ll n4 = v4.size();
		vector<ll> ans;
		if ((n1 + n2 == n)  && v1[0] == 1 && v1[n1 - 1] == n1 && v2[0] == 1 && v2[n2 - 1] == n2)
		{
			total++;
			ans.push_back(n1);
			ans.push_back(n2);
		...
		if ((n3 + n4 == n)  && v3[0] == 1 && v3[n3 - 1] == n3 && v4[0] == 1 && v4[n4 - 1] == n4)
		{
			if (n1 != n4)
			{
				total++;
