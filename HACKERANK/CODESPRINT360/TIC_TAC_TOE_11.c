...
int main()
{
 	...
 	if(str[0][0]==str[0][1] && str[0][2]==str[0][1])
 	{
 		if(str[0][0]=='O')
 		{
 			PFS("WALTER");
 	...
 	if(str[1][0]==str[1][1] && str[1][2]==str[1][1])
 	{
 		if(str[1][0]=='O')
 		{
 			PFS("WALTER");
 	...
 	if(str[2][0]==str[2][1] && str[2][2]==str[2][1])
 	{
 		if(str[2][0]=='O')
 		{
 			PFS("WALTER");
 	...
 	if(str[0][0]==str[1][1] && str[0][0]==str[2][2])
 	{
 		if(str[0][0]=='O')
 		{
 			PFS("WALTER");
 	...
 	if(str[0][0]==str[1][0] && str[2][0]==str[1][0])
 	{
 		if(str[0][0]=='O')
 		{
 			PFS("WALTER");
 	...
 	if(str[0][1]==str[1][1] && str[2][1]==str[1][1])
 	{
 		if(str[0][1]=='O')
 		{
 			PFS("WALTER");
 	...
 	if(str[0][2]==str[1][2] && str[2][2]==str[1][2])
 	{
 		if(str[0][2]=='O')
 		{
 			PFS("WALTER");
 	...
 	if(str[0][2]==str[1][1] && str[0][2]==str[2][0])
 	{
 		if(str[0][2]=='O')
 		{
 			PFS("WALTER");
