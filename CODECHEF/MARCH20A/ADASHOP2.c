...
int main()
{
    ll steps[25][2]={2,2,3,1,1,3,2,4,1,5,5,1,6,2,7,1,1,7,2,8,8,2,7,3,8,4,4,8,8,4,4,8,5,7,6,8,8,6,6,8,8,6,7,7,8,8};
    CASES
    {
        ll a,b;
        SC2(a,b);
