...
int main()
{
    CASES
    {
        ...
        if(n>=250001)
        {
            ll dif=minv(n,500000)-250000;
            tax+=dif*5/100;
        }
        if(n>=500001)
        {
            ll dif=minv(n,750000)-500000;
            tax+=dif*10/100;
        }
        if(n>=750001)
        {
            ll dif=minv(n,1000000)-750000;
            tax+=dif*15/100;
        }
        if(n>=1000001)
        {
            ll dif=minv(n,1250000)-1000000;
            tax+=dif*20/100;
        }
        if(n>=1250001)
        {
            ll dif=minv(n,1500000)-1250000;
            tax+=dif*25/100;
        }
        if(n>=1500001)
        {
