...
int main()
{
    ...
    CASES
    {
	    ...
	    REP(i,k)	//choosing the column to be compared with
	    {
	    	REP(j,k)	//choosing the column to compare
	    	{
	    		ll c=0;
	    		REP(l,n)	//choosing the question
	    		{
	    			if(arr[l][i]==arr[l][j])
	    			{
	    				c++;
