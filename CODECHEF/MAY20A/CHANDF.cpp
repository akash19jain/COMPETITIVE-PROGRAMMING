...
int main()
{
	...
	CASES
	{
		...
		if (ans > r)
		{
			...
			// if ((x & value) == 0 || (y & value) == 0 || (x & value1) == 0 || (y & value1) == 0 || (x & value2) == 0 || (y & value2) == 0)
			// {
			// 	PFS("0");
			// 	continue;
			// }

			if (((x & value) * (y & value)) >= ((x & value1) * (y & value1)) && ((x & value) * (y & value)) >= ((x & value2) * (y & value2)))
			{
			...
			if (((x & value1) * (y & value1)) >= ((x & value2) * (y & value2)) && ((x & value1) * (y & value1)) >= ((x & value) * (y & value)))
			{
				if ((x & value1) == 0 || (y & value1) == 0)
				{}
				else
				{
					PF1(value1);
			...
			if (((x & value2) * (y & value2)) >= ((x & value1) * (y & value1)) && ((x & value2) * (y & value2)) >= ((x & value) * (y & value)))
			{
				if ((x & value2) == 0 || (y & value2) == 0)
				{}
				else
				{
					PF1(value2);
