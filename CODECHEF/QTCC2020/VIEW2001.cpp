...
int main()
{
	...
	CASES
	{
		...
		{
			ans = amt * (0.84);
			cout << "$" << amt << " " << "CONVERTS" << " " << "TO" << " " << ans << " " << "POUNDS" << endl;
		}
		else if (s[0] == 'L')
		{
			ans = amt * 2040;
			cout << "$" << amt << " " << "CONVERTS" << " " << "TO" << " " << ans << " " << "LIRA" << endl;
		}
		else if (s[0] == 'F')
		{
			ans = amt * 9.85;
			cout << "$" << amt << " " << "CONVERTS" << " " << "TO" << " " << ans << " " << "FRANCS" << endl;
		}
		else if (s[0] == 'M')
		{
			ans = amt * 3.23;
			cout << "$" << amt << " " << "CONVERTS" << " " << "TO" << " " << ans << " " << "MARKS" << endl;
		}
		else if (s[0] == 'Y')
		{
			ans = amt * 260;
			cout << "$" << amt << " " << "CONVERTS" << " " << "TO" << " " << ans << " " << "YEN" << endl;
		}
	}
	return 0;
}
