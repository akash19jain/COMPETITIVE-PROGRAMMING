...
int main()
{
	...
	CASES
	{
		...
		if ((a != 0 && b != 0 && c != 0 && (x % a) == 0 && (y % b) == 0 && (z % c) == 0 && (x / a) == (y / b) && (x / a) == (z / c)))
		{
			PFS("1");
			continue;
		}
		...
		if (ans == 2)
		{
			...
			else if (d1 == 0 && b != 0 && c != 0 && (y % b) == 0 && (z % c) == 0 && (y / b) == (z / c))
			{
				PFS("1");
				continue;
			}
			else if (d2 == 0 && a != 0 && c != 0 && (x % a) == 0 && (z % c) == 0 && (x / a) == (z / c))
			{
				PFS("1");
				continue;
			}
			else if (d3 == 0 && a != 0 && b != 0 && (x % a) == 0 && (y % b) == 0 && (x / a) == (y / b))
			{
				PFS("1");
				continue;
			}
		...
		else if (a != 0 && b != 0 && (x % a) == 0 && (y % b) == 0 && (x / a) == (y / b))
		{
			PFS("2");
			continue;
		}
		else if (c != 0 && b != 0 && (z % c) == 0 && (y % b) == 0 && (z / c) == (y / b))
		{
			PFS("2");
			continue;
		}
		else if (c != 0 && a != 0 && (z % c) == 0 && (x % a) == 0 && (z / c) == (x / a))
		{
			PFS("2");
			continue;
		}
