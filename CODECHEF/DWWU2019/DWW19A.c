...
int main()
{
    CASES
    {
        char str[1000005];
        SCS(str);
        ll len=SZ(str),a=len-1;
        int f=0;
        //PF1(len/2);
        REP(i,len/2)
        {
            if((str[i]=='1' && str[a]=='1') || (str[i]=='2' && str[a]=='7') || (str[i]=='3' && str[a]=='8') || (str[i]=='4' && str[a]=='5') || (str[i]=='6' && str[a]=='9') || (str[i]=='7' && str[a]=='2') || (str[i]=='8' && str[a]=='3') || (str[i]=='5' && str[a]=='4') || (str[i]=='9' && str[a]=='6'))
            {
                a--;
                continue;
            }
