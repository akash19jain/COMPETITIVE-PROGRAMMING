...
int main()
{
    CASES
    {
        ...
        {
            for(ll j=i+2;j<a;j+=2)
            {
                for(ll k=maxv(j+2,2*n);k<a;k+=2)
                {
                    // DEB(i);
                    // DEB(j);
                    // DEB(k);
                    ...
                    //-4,0  0,2  0,-8
                    d1=pow((arr[i]-arr[j]),2)+pow((arr[i+1]-arr[j+1]),2);
                    d2=pow((arr[i]-arr[k]),2)+pow((arr[i+1]-arr[k+1]),2);
                    d3=pow((arr[k]-arr[j]),2)+pow((arr[k+1]-arr[j+1]),2);
